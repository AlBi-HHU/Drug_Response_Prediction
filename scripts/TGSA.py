...
from TGDRP import TGDRP, train, test
...
def load_graph_data_SA(x_cell, x_drug, y, inputs, path_to_TGDRP_model):
    ...
    cluster_predefine = get_predefine_cluster(x_cell[0].edge_index, 0.95, device)
...
if __name__ == "__main__":
    ...
    path_to_TGDRP_model = f'{n_splits}fold_cv/{inputs}/resampling_{resampling}/TGDRP/TGDRP_split{split}_best_model.pt'
